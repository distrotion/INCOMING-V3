...
class NoGoodConfirm extends StatelessWidget {
  NoGoodConfirm({Key? key, this.blockFINISH}) : super(key: key);
  bool? blockFINISH;

  @override
  Widget build(BuildContext context) {
    Widget outpage = WaittingP1();
    if (NOGOODcon.NoGoodPage == 1) {
      outpage = WaittingP1();
    } else if (NOGOODcon.NoGoodPage == 2) {
      ...
      children: [
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.all(Radius.circular(8)),
                          // color: Colors.white,
                          color: NOGOODcon.yesno == 1
                              ? Colors.black
                              : Colors.white,
                        ),
                        child: Center(
                          child: Text("YES",
                              style: NOGOODcon.yesno == 1
                                  ? TxtStyleBlackBG()
                                  : TxtStyleWhiteBG()),
                        ),
                      ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(width: 2.0, color: Colors.black),
                          borderRadius: BorderRadius.all(Radius.circular(8)),
                          color: NOGOODcon.yesno == 2
                              ? Colors.black
                              : Colors.white,
                        ),
                        child: Center(
                          child: Text("NO",
                              style: NOGOODcon.yesno == 2
                                  ? TxtStyleBlackBG()
                                  : TxtStyleWhiteBG()),
                        ),
                      ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: ComInputText(
                          height: 40,
                          width: 350,
                          isContr: NOGOODcon.undercontrol,
                          fnContr: (input) {
                            NOGOODcon.undercontrol = input;
                          },
                          sValue: NOGOODcon.SpacialAccText,
                          returnfunc: (String s) {
                            NOGOODcon.SpacialAccText = s;
                          },
                        ),
                      ),
                    )),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          // color: Colors.white,
                          color: NOGOODcon.attper == 1
                              ? Colors.black
                              : Colors.white,
                        ),
                        child: Center(
                          child: Text("QA/QC Engineer",
                              style: NOGOODcon.attper == 1
        ...
        Expanded(
          ...
          child: Padding(
            ...
            child: InkWell(
              onTap: () {
                if ((NOGOODcon.yesno == 1)) {
                  if ((NOGOODcon.attper != 0)) {
                    NOGOODcon.NoGoodPage = 2;
                    BlocProvider.of<BlocPageRebuild>(context).rebuildPage();
                  }
                } else {
      ...
      children: [
        Expanded(
          ...
          child: Row(
            ...
            children: [
              FileUploadButton01(),
              PicShow01(base64: NOGOODcon.base64pic01),
            ],
          ),
        ),
        Expanded(
          ...
          child: Row(
            ...
            children: [
              FileUploadButton02(),
              PicShow01(base64: NOGOODcon.base64pic02),
            ],
          ),
        ),
        Expanded(
          ...
          child: Row(
            ...
            children: [
              FileUploadButton03(),
              PicShow01(base64: NOGOODcon.base64pic03),
            ],
          ),
        ),
        Expanded(
          ...
          child: Row(
            ...
            children: [
              FileUploadButton04(),
              PicShow01(base64: NOGOODcon.base64pic04),
            ],
          ),
        ),
        Expanded(
          ...
          child: Row(
            ...
            children: [
              FileUploadButton05(),
              PicShow01(base64: NOGOODcon.base64pic05),
            ],
          ),
        ),
        Expanded(
...
class PicShow01 extends StatefulWidget {
  ...
  String base64 = NOGOODcon.base64pic01;
  @override
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          ...
          if ((blockfinish ?? true)) {
            INCOMINGDATAactive.modeNOGOOD = false;
            context.read<QUERYincm_Bloc>().add(updateINCM_WAIT());
          }
        },
        child: Container(
          decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: DropdownButton<String>(
        value: NOGOODcon.PiecesDropdownSelected,
        onChanged: (String? newValue) {
          NOGOODcon.PiecesDropdownSelected = newValue ?? '1';
          BlocProvider.of<BlocPageRebuild>(context).rebuildPage();
        },
        items: items
