...
class INCOMINGDATAactive {
  ...
  static String specialAccPicNow = '';
  static String confirmPass = '';
  static String wait = '';
  static String PassText = '';
}

class INCOMINGDATAoutput {
  static String MATNRnow = '';
  static String CHARGnow = '';
  static String MBLNRnow = '';
  static String BWARTnow = '';
  static String MENGEnow = '';
  static String MEINSnow = '';
  static String MAT_FGnow = '';
  static String KUNNRnow = '';
  static String SORTLnow = '';
